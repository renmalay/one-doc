...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="absolute inset-0 mx-4 sm:mx-8 md:mx-12 lg:mx-20 xl:mx-25">
          ...
          {/* Left Side */}
            <div className="w-full mt-10 md:w-1/2 flex flex-col justify-center text-white" data-aos="fade-right" data-aos-duration="2000">
              <h2 className={`mt-20 flex flex-col gap-1 md:gap-5 ${rethinkSans.className} font-bold justify-around sm:justify-start text-4xl md:text-5xl lg:text-6xl`}>
      ...
      <div className="bg-[var(--company-color)] w-full text-white grid grid-cols-1 md:grid-cols-3 py-5 gap-5 md:py-0 md:gap-0 items-center text-center px-20">
      ...
      <div className="bg-blue-900 w-full text-white items-center text-center">
        <h1 className="text-1xl sm:text-4xl md:text-5xl lg:text-6xl py-100">FOOTER</h1>
      </div>
    </>
  );
}
